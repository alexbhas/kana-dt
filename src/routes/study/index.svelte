...
<svelte:head>
	<title>Study · Kana DT</title>
</svelte:head>

<div class="wrapper">
	<fieldset class="kana-type">
		<legend>I want to study...</legend>
		<div class="radio-buttons">
			<Radio
				id="kana-type-hiragana-choice"
				name="kana-type"
				bind:group={$gameConfig.kanaStudy}
				value="hiragana"
			>
				Hiragana
			</Radio>
	...
	<p style="text-align: center; margin: 0;">(Coming Soon) Click for pronunciations</p>
